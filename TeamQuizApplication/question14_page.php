...
<?php
    ...
    {
        $_SESSION["answer13"]=$_POST["answer"];
    }
    else if(isset($_POST["prev"]) && isset($_POST["answer"]))
    {
        $_SESSION["answer15"]=$_POST["answer"];
    }
    if($_SESSION["answer14"]!='')
    {
        switch($_SESSION["answer14"])
        {
            case $row['option1']:
                $option1="checked";
                break;
...
<html>
    ...
    <body>
        ...
        <form class="form-horizontal" role="form" name="optionForm" id="option-form" method="post">
            ...
            <div>
                <input type="submit" name="prev" class="button" value="Previous" formaction="question13_page.php">
                <input type="submit" name="questions14" class="button" value="Questions" formaction="questions.php">
                <input type="submit" name="next" class="button" value="Next" formaction="question15_page.php">
                <input type="submit" name="submit14" class="button" value="Submit" formaction="result.php">
            </div>
