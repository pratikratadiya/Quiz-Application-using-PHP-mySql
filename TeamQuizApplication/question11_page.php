...
<?php
    ...
    {
        $_SESSION["answer10"]=$_POST["answer"];
    }
    else if(isset($_POST["prev"]) && isset($_POST["answer"]))
    {
        $_SESSION["answer12"]=$_POST["answer"];
    }
    if($_SESSION["answer11"]!='')
    {
        switch($_SESSION["answer11"])
        {
            case $row['option1']:
                $option1="checked";
                break;
...
<html>
    ...
    <body>
        ...
        <form class="form-horizontal" role="form" name="optionForm" id="option-form" method="post">
            ...
            <div>
                <input type="submit" name="prev" class="button" value="Previous" formaction="question10_page.php">
                <input type="submit" name="questions11" class="button" value="Questions" formaction="questions.php">
                <input type="submit" name="next" class="button" value="Next" formaction="question12_page.php">
                <input type="submit" name="submit11" class="button" value="Submit" formaction="result.php">
            </div>
