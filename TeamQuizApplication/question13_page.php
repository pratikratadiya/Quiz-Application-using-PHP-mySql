...
<?php
    ...
    {
        $_SESSION["answer14"]=$_POST["answer"];
    }
    if($_SESSION["answer13"]!='')
    {
        switch($_SESSION["answer13"])
        {
            case $row['option1']:
                $option1="checked";
                break;
...
<html>
    ...
    <body>
        ...
        <form class="form-horizontal" role="form" name="optionForm" id="option-form" method="post">
            ...
            <div>
                <input type="submit" name="prev" class="button" value="Previous" formaction="question12_page.php">
                <input type="submit" name="questions13" class="button" value="Questions" formaction="questions.php">
                <input type="submit" name="next" class="button" value="Next" formaction="question14_page.php">
                <input type="submit" name="submit13" class="button" value="Submit" formaction="result.php">
            </div>
