...
<?php
    ...
    {
        $_SESSION["answer20"]=$_POST["answer"];
    }
    if($_SESSION["answer19"]!='')
    {
        switch($_SESSION["answer19"])
        {
            case $row['option1']:
                $option1="checked";
                break;
...
<html>
    ...
    <body>
        ...
        <form class="form-horizontal" role="form" name="optionForm" id="option-form" method="post">
            ...
            <div>
                <input type="submit" name="prev" class="button" value="Previous" formaction="question18_page.php">
                <input type="submit" name="questions19" class="button" value="Questions" formaction="questions.php">
                <input type="submit" name="next" class="button" value="Next" formaction="question20_page.php">
                <input type="submit" name="submit19" class="button" value="Submit" formaction="result.php">
            </div>
