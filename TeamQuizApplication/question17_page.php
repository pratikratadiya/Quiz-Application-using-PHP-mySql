...
<?php
    ...
    {
        $_SESSION["answer16"]=$_POST["answer"];
    }
    else if(isset($_POST["prev"]) && isset($_POST["answer"]))
    {
        $_SESSION["answer18"]=$_POST["answer"];
    }
    if($_SESSION["answer17"]!='')
    {
        switch($_SESSION["answer17"])
        {
            case $row['option1']:
                $option1="checked";
                break;
...
<html>
    ...
    <body>
        ...
        <form class="form-horizontal" role="form" name="optionForm" id="option-form" method="post">
            ...
            <div>
                <input type="submit" name="prev" class="button" value="Previous" formaction="question16_page.php">
                <input type="submit" name="questions17" class="button" value="Questions" formaction="questions.php">
                <input type="submit" name="next" class="button" value="Next" formaction="question18_page.php">
                <input type="submit" name="submit17" class="button" value="Submit" formaction="result.php">
            </div>
