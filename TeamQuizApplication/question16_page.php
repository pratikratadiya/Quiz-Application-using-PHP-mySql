...
<?php
    ...
    if($_SESSION["answer16"]!='')
    {
        switch($_SESSION["answer16"])
        {
            case $row['option1']:
                $option1="checked";
                break;
...
<html>
    ...
    <body>
        ...
        <form class="form-horizontal" role="form" name="optionForm" id="option-form" method="post">
            ...
            <div>
                <input type="submit" name="prev" class="button" value="Previous" formaction="question15_page.php">
                <input type="submit" name="questions16" class="button" value="Questions" formaction="questions.php">
                <input type="submit" name="next" class="button" value="Next" formaction="question17_page.php">
                <input type="submit" name="submit16" class="button" value="Submit" formaction="result.php">
            </div>
