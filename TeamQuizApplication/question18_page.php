...
<?php
    ...
    {
        $_SESSION["answer17"]=$_POST["answer"];
    }
    else if(isset($_POST["prev"]) && isset($_POST["answer"]))
    {
        $_SESSION["answer19"]=$_POST["answer"];
    }
    if($_SESSION["answer18"]!='')
    {
        switch($_SESSION["answer18"])
        {
            case $row['option1']:
                $option1="checked";
                break;
...
<html>
    ...
    <body>
        ...
        <form class="form-horizontal" role="form" name="optionForm" id="option-form" method="post">
            ...
            <div>
                <input type="submit" name="prev" class="button" value="Previous" formaction="question17_page.php">
                <input type="submit" name="questions18" class="button" value="Questions" formaction="questions.php">
                <input type="submit" name="next" class="button" value="Next" formaction="question19_page.php">
                <input type="submit" name="submit18" class="button" value="Submit" formaction="result.php">
            </div>
