...
<html>
    ...
    <body>
        ...
        <form class="form-horizontal" role="form" name="optionForm" id="option-form" method="post">
            ...
            <div>
                <input type="submit" name="prev" class="button" value="Previous" formaction="question3_page.php">
                <input type="submit" name="questions4" class="button" value="Questions" formaction="questions.php">
                <input type="submit" name="next" class="button" value="Next" formaction="question5_page.php">
                <input type="submit" name="submit4" class="button" value="Submit" formaction="result.php">
            </div>
