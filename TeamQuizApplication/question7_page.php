...
<html>
    ...
    <body>
        ...
        <form class="form-horizontal" role="form" name="optionForm" id="option-form" method="post">
            ...
            <div>
                <input type="submit" name="prev" class="button" value="Previous" formaction="question6_page.php">
                <input type="submit" name="questions7" class="button" value="Questions" formaction="questions.php">
                <input type="submit" name="next" class="button" value="Next" formaction="question8_page.php">
                <input type="submit" name="submit7" class="button" value="Submit" formaction="result.php">
            </div>
