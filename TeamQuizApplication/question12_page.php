...
<?php
    ...
    {
        $_SESSION["answer11"]=$_POST["answer"];
    }
    else if(isset($_POST["prev"]) && isset($_POST["answer"]))
    {
        $_SESSION["answer13"]=$_POST["answer"];
    }
    if($_SESSION["answer12"]!='')
    {
        switch($_SESSION["answer12"])
        {
            case $row['option1']:
                $option1="checked";
                break;
...
<html>
    ...
    <body>
        ...
        <form class="form-horizontal" role="form" name="optionForm" id="option-form" method="post">
            ...
            <div>
                <input type="submit" name="prev" class="button" value="Previous" formaction="question11_page.php">
                <input type="submit" name="questions12" class="button" value="Questions" formaction="questions.php">
                <input type="submit" name="next" class="button" value="Next" formaction="question13_page.php">
                <input type="submit" name="submit12" class="button" value="Submit" formaction="result.php">
            </div>
